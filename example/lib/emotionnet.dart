...
class HomePagex extends StatefulWidget {
  @override
  HomePagexState createState() => new HomePagexState();
}
...
speak() async {
  if($face.length > 5)
  {
Tts.speak("A "+$age.toString()+" year old "+$ethnicity+""+ $gender+" which seems to be looking "+$f_emotion+" and have beauty score of"+ $beauty.toString()+"");
}
else
{ 
