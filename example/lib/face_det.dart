...
class MyHomePagey extends StatefulWidget {
  @override
  _MyHomePageyState createState() => new _MyHomePageyState();
}

class _MyHomePageyState extends State<MyHomePagey> {
  File imageFile;
  ...
  Widget build(BuildContext context) {
    ...
    isi_menu_home.add(new RaisedButton
              (
                ...
                onPressed: (){Navigator.of(context).pushNamed('/seventh');},
              ));*/
